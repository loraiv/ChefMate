    ...
    private fun showDifficultyDialog() {
        ...
        androidx.appcompat.app.AlertDialog.Builder(requireContext())
            ...
            .setItems(difficulties) { _, which ->
                ...
                binding.filterDifficulty.text = if (selected == null) "Difficulty" else difficulties[which]
            }
            .show()
    }

    private fun showTimeDialog() {
        val timeOptions = arrayOf("All", "Up to 30 min", "Up to 60 min", "Up to 120 min")
        ...
        androidx.appcompat.app.AlertDialog.Builder(requireContext())
            ...
            .setItems(timeOptions) { _, which ->
                ...
                binding.filterTime.text = if (selected == null) "Time" else timeOptions[which]
            }
            .show()
    }
            ...
            viewModel.error.collect { error ->
                error?.let {
                    ...
                    if (it.contains("expired", ignoreCase = true) || 
                        it.contains("access", ignoreCase = true) ||
                        it.contains("authorized", ignoreCase = true)) {
                        val tokenManager = TokenManager(requireContext())
