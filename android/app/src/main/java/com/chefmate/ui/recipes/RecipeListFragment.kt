...
class RecipeListFragment : Fragment() {
    ...
    private fun navigateToRecipeDetail(recipeId: Long) {
        ...
        findNavController().navigate(com.chefmate.R.id.action_recipeList_to_recipeDetail, bundle)
    }

    private fun navigateToAddRecipe() {
        findNavController().navigate(com.chefmate.R.id.action_recipeList_to_addRecipe)
    }
